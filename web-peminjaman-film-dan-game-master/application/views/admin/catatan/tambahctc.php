			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php echo site_url('admin/C_catatan/tambah') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group row">
								<label for="alamat" class="col-sm-2 col-form-label">Catatan</label>
								<div class="col-sm-10">
									<textarea class="form-control <?= set_value('catatan'); ?>" id="catatan" name="catatan" rows="3"></textarea>
									...
									<div class="col-sm-10">
										<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" id="jenis" name="jenis" value="Penting" <?php if (set_value('jenis') == "Penting") : echo "checked";
																																		endif; ?>><fieldset class="form-group">
											...
											<div class="form-check form-check-inline">
											<input class="form-check-input" type="radio" id="jenis2" name="jenis" value="biasa" <?php if (set_value('jenis') == "Biasa") : echo "checked";
																																		endif; ?>><fieldset class="form-group">
