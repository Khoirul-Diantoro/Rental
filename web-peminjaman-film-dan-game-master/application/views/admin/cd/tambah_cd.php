			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/C_cd') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">

						<form action="<?php echo site_url('admin/C_cd/tambah') ?>" method="post" enctype="multipart/form-data" >
							<div class="form-group">
								<label for="nama_cd">Nama*</label>
								<input class="form-control <?php echo form_error('nama_cd') ? 'is-invalid':'' ?>"
								 type="text" name="nama_cd" placeholder="Nama CD" />
